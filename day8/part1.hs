...
solve :: (Map.Map Int Instruction) -> Int
solve map = runInstructions (L) map 0 0

runInstructions :: Tree Int -> (Map.Map Int Instruction) -> Int -> Int -> Int
runInstructions pastInstTree map instNum acc =
         ...
         Nothing -> 
            ...
            case curInst of
               ...
               Just v  ->  let updatedVals = runInst v acc in
                              runInstructions updTree map (fst updatedVals) (snd updatedVals) )
